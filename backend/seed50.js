...
async function seed() {
  try {
    ...
    console.log("Cleared existing generic problems collection.");

    const inserted = await Problem.insertMany(problemsToInsert);
    console.log(`Successfully re-seeded ${inserted.length} problems with accurate problem-specific metadata!`);
